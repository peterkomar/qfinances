...
void Finances::create_gui()
{
    ...
    addBtn->setIconSize(QSize(70,70));
    ...
    printT->setIconSize(QSize(70,70));
    ...
    confBtn->setIconSize(QSize(70,70));
    ...
    helpBtn->setIconSize(QSize(70,70));
...
void Finances::load_list_operation(QList<Db_dat>& list, const QString& sHeader)
{
    ...
    for (int i = 0; i < list.size(); ++i) {
	  ...
	  s = "- "+ QString::number(dat.count_d,'F' ,2)+" "+dat.currency;
	  item->setTextColor(2,QColor(Qt::red));
...
void Finances::slot_about()
{
	QMessageBox::about(this,
        tr("About QFinances"),
                tr("<b>QFinances 1.0.1</b> - personal home finances manager.<br>") +
                tr(
                           "Copyright (C) 2008-2015<br/>"
                           "<b>Developers</b>:<br/>"
                           "&nbsp;<a href=\"mailto:udldevel@gmail.com\">Peter Komar</a> - founder, lead developer<br/>"
                   )
    );
}
...
{
    QMessageBox::aboutQt(this,"QFinances");
}
